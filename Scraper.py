...
class GoogleScraper:
    ...
    def __init__(self, query=''):
        ...
        self.start_url = "https://www.google.com/search?q=%s&source=lnms&tbm=isch" % query
    ...
    def start(self):
        ...
        self.url_frontier = img_urls

        while len(self.url_frontier) > 0:
            try:
                ...
                img_urls = self.getImgURLS(link_to_visual_neighbours)
