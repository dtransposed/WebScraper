...
if __name__ == '__main__':
    main()
'''   
######################## RUN THE CODE Args: (query, directory for download, number of pictures)######
directory = 'C:/Users/tatar/Desktop/GANs/00_Project_Piotr/foto_test'
run('watch', directory, 20)